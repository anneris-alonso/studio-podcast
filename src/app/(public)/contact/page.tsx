...
export default function ContactPage() {
    return (
        <main className="min-h-screen bg-black text-white relative overflow-hidden flex flex-col">
            ...
            <div className="flex-1 flex items-center relative z-10 pt-20 pb-10">
                <div className="px-6 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center w-full">

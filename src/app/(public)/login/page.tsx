...
function LoginFormContent() {
  ...
  const loginWithGoogle = () => {
    if (window.google) {
      window.google.accounts.id.prompt(); // Supports One Tap if configured
      // Or explicit button click behavior
        ...
        <div className="glass-card-premium p-8 lg:p-10 border-white/10 bg-white/[0.03] shadow-2xl shadow-black">
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="flex items-center gap-4 py-4">
              ...
              <div className="text-[10px] uppercase tracking-widest text-white/50 font-bold whitespace-nowrap">
                Or continue with
              </div>
              <div className="flex-1 border-t border-white/10"></div>
            </div>

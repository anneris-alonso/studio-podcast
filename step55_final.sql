...
-- AlterTable
ALTER TABLE "booking_line_items" ADD COLUMN     "total_price_minor_snapshot" INTEGER NOT NULL DEFAULT 0,
ADD COLUMN     "unit_price_minor_snapshot" INTEGER NOT NULL DEFAULT 0;

-- AlterTable
ALTER TABLE "bookings" ADD COLUMN     "total_price_minor_snapshot" INTEGER NOT NULL DEFAULT 0;

-- AlterTable
ALTER TABLE "packages" ADD COLUMN     "max_quantity" INTEGER NOT NULL DEFAULT 12,
...
-- AlterTable
ALTER TABLE "services" ADD COLUMN     "max_quantity" INTEGER NOT NULL DEFAULT 20,
ADD COLUMN     "min_quantity" INTEGER NOT NULL DEFAULT 1,

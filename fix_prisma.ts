...
model StudioMedia {
  ...
  studioRoom StudioRoom @relation(fields: [studioRoomId], references: [id], onDelete: Cascade)
...
model Subscription {
  ...
  subscriptionActiveEmailSentAt DateTime?          @map("subscription_active_email_sent_at")
  createdAt            DateTime           @default(now()) @map("created_at")
...
model Booking {
  ...
  calendarInviteSentAt    DateTime? @map("calendar_invite_sent_at")
  calendarProvider        String?   @map("calendar_provider")
  calendarEventUid        String?   @unique @map("calendar_event_uid")
  ...
  bookingPaidEmailSentAt  DateTime? @map("booking_paid_email_sent_at")
